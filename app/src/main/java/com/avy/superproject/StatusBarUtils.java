...
public class StatusBarUtils {
    ...
    public static void setYtfStatusBar(AppCompatActivity activity, int statusBg, boolean darkMode) {

        final int gray = ContextCompat.getColor(activity, R.color.white);
    ...
    public static void setYtfLightStatusBar(AppCompatActivity activity) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private static void setStatusBarBackground_V21(AppCompatActivity activity, int color) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private static void setStatusBarBackground_V19(AppCompatActivity activity, int color) {
        Window window = activity.getWindow();
